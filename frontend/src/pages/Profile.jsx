...
class _Profile extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({userRequests:this.props.loggedInUser.pets})
    }
    ...
    socketListeners = () => {
        ...
        socketService.on('adopt-request-owner-data', (updatedPets) => {
    ...
    render() {
        const { loggedInUser, isAddingRequest, userPetQue } = this.props
